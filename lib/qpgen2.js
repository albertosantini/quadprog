...
function qpgen2(dmat, dvec, fddmat, n, sol, lagr, crval, amat, bvec, fdamat, q, meq, iact, nnact, iter, work, ierr) {
    let l1, it1, nvl, nact, temp, sum, t1, tt, gc, gs, nu, t1inf, t2min, go, removedConstraint;
    ...
    const activeConstraints = new Array(q + 1).fill(false);
    ...
    function fnGoto799() {
        ...
        work[iwuv + nact + 1] = 0;
        activeConstraints[removedConstraint] = false;
        removedConstraint = 0;
        iact[nact] = 0;
        nact -= 1;
        iter[2] += 1;
